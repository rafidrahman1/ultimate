    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const _SyncStep(number: '3', text: 'Turn on Sleep sync for Samsung Health.'),
          const _SyncStep(number: '4', text: 'Open Health Connect → App permissions → Samsung Health → allow Sleep.'),
