...
class LocationSettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppScreenAppBar.build(context, ref, title: 'Location settings'),
        ...
        data: (settings) => ListView(
          ...
          children: [
            const SectionHeader(
              'Timeline folder',
              subtitle:
                  'Choose the folder where Google Timeline export exists (for example Download/Timeline). '
                  'The app auto-loads Timeline.json from that folder.',
            ),
            ...
            const SizedBox(height: 16),
            Text(
              'Expected file name: Timeline.json',
