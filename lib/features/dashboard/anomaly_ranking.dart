...
List<AnomalyCandidate> buildAnomalyCandidates({
  ...
  if (expenseSummary != null && expenseSummary.transactions.isNotEmpty) {
    ...
    final incomeBaseline = expenseSummary.totalIncome;
    ...
    final suppressSpendingCluster = belowIncomeCap && explainedByCalendar;
    if (topSpendingShare >= spendingClusterMinSpendingShare &&
      ...
      if (belowIncomeCap && explainedByCalendar && !hasCrossDomainImpact) {
