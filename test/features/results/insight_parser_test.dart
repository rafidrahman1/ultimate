...
''';
    ...
    expect(
      sections.any((s) => s.title.toLowerCase().contains('highlight')),
      isTrue,
    );
...
*   **Low Daily Movement Pattern:** Your daily steps are low (averaging **4,017 steps**), and this pattern appears consistently across workdays. This lower baseline likely contributes to reduced recovery and energy dips.
...
#### **3. Daily Movement**
*   **Add one short walk block:** Add one 20-minute walk after lunch on at least 4 days this week to naturally increase your baseline movement.
''';
